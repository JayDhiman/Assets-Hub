...
const SoftwareDetails = ({Software,onClose}) => {
  ...
  const handleDetailsClick = () => {
    ...
    navigate(`/dashboard/software/${Software.id}`);
  };
    ...
    <div className="bg-gray-200 rounded-lg shadow-lg p-6 max-w-lg w-full relative">
      ...
      (
        <div className="text-black text-center">
          ...
          <div className='mt-2'> {Software.software}</div>

          <div className='flex items-center justify-center gap-4 flex-wrap mt-3'>
            <div className='flex items-center justify-center gap-1'>
             
              <h1 className='font-extralight'> Version: {Software.version}</h1>
            </div>
            <div className='flex items-center justify-center gap-1'>
            ...
            <div className='flex items-center justify-center gap-1'>
              ...
              <h1 className='font-extralight'> Vendor: {Software.vendor}</h1>
            </div>
          </div>
        </div>
      )}
